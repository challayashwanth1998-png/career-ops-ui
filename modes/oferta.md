# Mode: offer — Comprehensive A-G Evaluation
...
Section for **gaps** with a mitigation strategy for each. For each gap:
...
Table with data and cited sources. If no data, state it instead of inventing.
